...
public class MainController {
    ...
    public String addUserPost(@ModelAttribute("user") Account user) {
    ...
    public String updateUserPost(@ModelAttribute("userP") Account user) {

        // 更新用户信息

        accountRepository.saveAndFlush(user); // 刷新缓冲区
        return "redirect:/admin/users";
    }

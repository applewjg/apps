...
//      }
        ...
        if (null != account) {
            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo(account.getUsername(), account.getPassword(), this.getName());
            this.setSession("currentUser", account.getUsername());
            return authcInfo;
        }
